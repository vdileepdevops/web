...
@Component({
  selector: 'app-interest-payment-trend-report',
  templateUrl: './interest-payment-trend-report.component.html',
  styles: []
})
export class InterestPaymentTrendReportComponent implements OnInit {

    InterestPaymentTrendForm: FormGroup;
    ...
    InterestPaymentTrendErrors: any;
    table: any;
    showmonth : any;
    currentmonth: any;
    Detailsdata: any = [];
    ...
    public totalpinterestamount: any;
    ...
    ngOnInit() {
        debugger;
        this.InterestPaymentTrendForm = this.FB.group({
            pAsOn: [this.today],
        })
        debugger;
        this.InterestPaymentTrendErrors = {};
    ...
    GetShowInterestPaymentTrend() {
        ...
        this.gridData1 = [];
        this._LAReportsService.ShowInterestPaymentReport().subscribe(result => {
            debugger;
    ...
    getMaturityDetails(DataItem, currentmonth) {
        ...
        this.Detailsdata = [];
        this._LAReportsService.ShowInterestTrendShemeAndDatewiseDetails(DataItem.pschemename, currentmonth).subscribe(result => {
            debugger;
    ...
    getMaturityTotalDetails(currentmonth) {
        ...
        this.Detailsdata.empty;
        this.Detailsdata = [];
        this._LAReportsService.ShowInterestTrendGrandTotalDatewiseDetails(currentmonth).subscribe(result => {
            debugger;
            this.Detailsdata = result;
            this.showdetails = true;
            this.getDetailsColumnWisetotals();
    ...
    GetPrintInterestPaymentTrend()
    {
        let a=this.datepipe.transform(this.InterestPaymentTrendForm.controls.pAsOn.value,'MMM-yyyy')
     
        this.receipt = btoa(a);
        window.open('/#/Interestpaymentrenddetails?id='+ this.receipt)
    }
    pdf() {
        debugger;
        let temp;
