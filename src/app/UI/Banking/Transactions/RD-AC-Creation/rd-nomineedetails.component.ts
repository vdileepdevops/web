...
@Component({
  selector: 'app-rd-nomineedetails',
  templateUrl: './rd-nomineedetails.component.html'
})
export class RdNomineedetailsComponent implements OnInit {
  ...
  ngOnInit()
   {
    ...
    {
      debugger
      console.log("nominee details",response);
      let a=response;
